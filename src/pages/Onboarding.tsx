    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-blue-700">
              AI-generated workout plans tailored to your goals and equipment
            </p>
          </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-md p-4">
          <h3 className="text-sm font-medium text-amber-900 mb-2">🎯 Important Note</h3>
          <p className="text-sm text-amber-700">
            This app provides fitness and nutrition guidance for educational purposes only. Always consult with
            healthcare professionals before starting new exercise or nutrition programs.
          </p>
        </div>
      </div>
    </div>
